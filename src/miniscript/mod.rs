...
mod private {
    ...
    impl<Pk: MiniscriptKey, Ctx: ScriptContext> Miniscript<Pk, Ctx> {
        ...
        pub fn from_ast(t: Terminal<Pk, Ctx>) -> Result<Miniscript<Pk, Ctx>, ConstructError> {
            let res = Miniscript {
                ty: Type::type_check(&t).map_err(ConstructError::TypeCheck)?,
...
mod tests {
    ...
    fn duplicate_keys() {
        ...
        assert!(matches!(
            err,
            ParseMiniscriptError::Construct(ConstructError::Validation(
    ...
    fn test_dos() {
        ...
        assert!(matches!(
            ...
            Err(ParseMiniscriptError::Construct(ConstructError::Validation(
    ...
    fn test_context_global_consensus() {
        ...
        assert_eq!(
            ...
            "a satisfaction path executes at least 210 non-push opcodes (limit: 201).",
        );
        assert_eq!(
